        ...
        %		    ytick={0, 1000, 2000, 3000},
        		%	point meta=y *10^3, % the displayed number
        		  %  legend pos=north east,
        		    legend style={at={(0.43, 0.75)},anchor=west},
        		    %ymajorgrids=true,    
        		    %xmajorgrids=true,
            		...
            		\legend{S1: w/ offloading w/ BMS, S2: w/ offloading w/o BMS, S3: w/o offloading w/ BMS, S4: w/o offloading w/o BMS}
        		
        		\end{axis}
    		\end{tikzpicture}
    		
        \end{center}
    \caption{The total CF as function of the server capacity $H$ with $L = 10$.}\label{fig:result3}
\end{figure}
